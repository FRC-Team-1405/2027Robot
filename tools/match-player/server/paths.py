...
match-player reuses vision_analyzer's stdlib-only .wpilog parser and field constants
...
def ensure_server_on_path() -> pathlib.Path:
    """Lets `from model import ...` work when match-player is imported as a library

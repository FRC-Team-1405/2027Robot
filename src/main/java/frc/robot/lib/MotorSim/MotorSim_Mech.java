 ...
 * STOLEN FROM: https://github.com/CrossTheRoadElec/Phoenix6-Examples/blob/main/java/MotionMagic/src/main/java/frc/robot/Mechanisms.java
 */
public class MotorSim_Mech {
   ...
   MechanismLigament2d side8 = side7.append(new MechanismLigament2d("side8", 0.15307, 45, 6, new Color8Bit(Color.kAliceBlue)));
    ...
    public MotorSim_Mech(String mechanismName) {
    ...
    public void update(StatusSignal<Angle> position, StatusSignal<AngularVelocity> velocity) {
        ...
        SmartDashboard.putData(mechanismName, mech); // Creates mech2d in SmartDashboard
    }
}